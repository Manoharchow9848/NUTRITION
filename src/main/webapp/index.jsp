...
<div id="carouselExampleIndicators" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="IMG/slide2.png" class="d-block w-100" alt="..." height="500px">
    </div>
    <div class="carousel-item">
      <img src="IMG/slide2.png" class="d-block w-100" alt="..." height="500px">
    </div>
    <div class="carousel-item">
      <img src="IMG/slide3.jpeg" class="d-block w-100" alt="..." height="500px">
    </div>
  </div>
...
<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img alt="" src="IMG/doc.jpg" width="500px" height="500px">
			</div>
